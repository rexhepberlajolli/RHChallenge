...
class ClientListViewTest(LoginSetup):
    def setUp(self):
        ...
        self.url = reverse_lazy('UserAdministration:ClientListView')
...
class ClientCreateViewTest(LoginSetup):
    def setUp(self):
        super(ClientCreateViewTest, self).setUp()
        self.url = reverse_lazy('UserAdministration:ClientCreateView')
...
class ClientDetailViewTest(LoginSetup):
    def setUp(self):
        ...
        self.custom_client = Clients.objects.create(first_name='RH', last_name='CH', iban='IBAN')
        self.url = reverse_lazy('UserAdministration:ClientDetailView', kwargs={'pk': self.custom_client.pk})
...
class ClientUpdateViewTest(LoginSetup):
    ...
    def setUp(self):
        ...
        self.first_url = reverse_lazy('UserAdministration:ClientUpdateView', kwargs={'pk': self.first_c.pk})
        self.second_url = reverse_lazy('UserAdministration:ClientUpdateView', kwargs={'pk': self.second_c.pk})

    def test_update_client(self):
        self.client.post(self.first_url, data=self.changed_data)
    ...
    def test_update_forbidden_client(self):
        self.client.post(self.second_url, data=self.changed_data)
...
class ClientDeleteViewTest(LoginSetup):
    def setUp(self):
        ...
        self.url = reverse_lazy('UserAdministration:ClientDeleteView', kwargs={'pk': self.first_c.pk})
